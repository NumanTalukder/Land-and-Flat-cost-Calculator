...
function calculate() {
    ...
    infoData.innerHTML = `
        ...
        <td>${((landSize.value * 3200) / shareCount.value).toFixed(2) - (1500 / shareCount.value)}</td>
    `
    ...
    costData.innerHTML = `
        <td>${serial}</td>
        <td>2800</td>
        <td>${numberWithCommas((priceLand.value / shareCount.value).toFixed(2))}</td>
        <td>${numberWithCommas((((landSize.value * 3200) / shareCount.value).toFixed(2)) * 2800)}</td>
        <td>${numberWithCommas(((priceLand.value / shareCount.value) + ((((landSize.value * 3200) / shareCount.value)) * 2800)).toFixed(2))}</td>
        <td>${numberWithCommas((((priceLand.value / shareCount.value) + ((landSize.value * 3200) / shareCount.value) * 2800) / (((landSize.value * 3200) / shareCount.value))).toFixed(2))}</td>
        <td>${numberWithCommas((priceLand.value / shareCount.value).toFixed(2))}</td>
        <td>${numberWithCommas(((((((landSize.value * 3200) / shareCount.value).toFixed(2)) * 2800)/36)).toFixed(2))}</td>
